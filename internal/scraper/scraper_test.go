...
func TestProcessTable(t *testing.T) {
	...
	assert.Equal(t, 912398891767, translators[0].ID)
	...
	assert.Equal(t, 742938749238, translators[1].ID)
	...
	assert.Equal(t, 4978238467, translators[2].ID)
	...
	assert.Equal(t, 789883493, translators[8].ID)
	...
	assert.Equal(t, 918374671, translators[13].ID)
